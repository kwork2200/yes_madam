...
class SearchLandingWidget extends StatelessWidget {
  final search.SearchController controller;

  const SearchLandingWidget({super.key, required this.controller});
      ...
      child: Column(
        ...
        children: [
          Padding(
            ...
            child: const CommonText(text: "Recent Searches"),
          ),
          ...
          SizedBox(
            ...
            child: ListView.separated(
              ...
              itemBuilder: (_, i) {
                final item = controller.recentSearches[i];
          ...
          Padding(
            padding: EdgeInsets.symmetric(horizontal: 18.w),
            child: const CommonText(text: "Popular Picks"),
          ),
          ...
          SizedBox(
            ...
            child: ListView.builder(
              ...
              itemBuilder: (_, i) {
                final service = controller.popularPicks[i];
          ...
          Padding(
            padding: EdgeInsets.symmetric(horizontal: 18.w),
            child: const CommonText(text: "Trending searches near you"),
          ),
          ...
          Padding(
            ...
            child: Wrap(
              spacing: 12.w,
              runSpacing: 14.h,
              children: controller.trendingSearches.map((t) {
                return TrendingChipCard(
                  title: t,
                  onTap: () => controller.setQuery(t),
                );
              }).toList(),
            ),
          ),
